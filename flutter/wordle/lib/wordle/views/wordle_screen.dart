...
class _WordleScreenState extends State<WordleScreen> {
  ...
  int _cuurrentWordIndex = 0;

  Word? get _currentWord =>
      _cuurrentWordIndex < _board.length ? _board[_cuurrentWordIndex] : null;
  ...
  // TODO : some logic issues here, refactor to meet all edge cases
    ...
    if (_gameStatus == GameStatus.playing &&
      ...
      for (var i = 0; i < _currentWord!.letters.length; i++) {
        ...
        await Future.delayed(
          ...
          () => _flipCardKeys[_cuurrentWordIndex][i].currentState?.toggleCard(),
        );
      }
      _checkIfWinOrLoss();
    }
  ...
  void _checkIfWinOrLoss() {
    if (_currentWord!.wordString == _solution.wordString) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: const Text("you won", style: TextStyle(color: Colors.white)),
    ...
    } else if (_cuurrentWordIndex + 1 >= _board.length) {
    ...
    _cuurrentWordIndex += 1;
  }

  void _restart() {
    setState(() {
      _gameStatus = GameStatus.playing;
      _cuurrentWordIndex = 0;
      _board
        ..clear()
        ..addAll(
          List.generate(
