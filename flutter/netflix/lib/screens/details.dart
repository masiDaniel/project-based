...
class DetailsScreen extends StatefulWidget {
  ...
  const DetailsScreen({super.key, required Entry entry}) : _entry = entry;
          ...
          Expanded(
            child: Row(
              ...
              children: [
                ...
                VerticalIconButton(
                  icon:
                      context.read<WatchListProvider>().isOnList(widget._entry)
                      ? Icons.check
                      : Icons.add,
                  title: "My List",
                  tap: () {
                    if (context.read<WatchListProvider>().isOnList(
                      widget._entry,
                    )) {
